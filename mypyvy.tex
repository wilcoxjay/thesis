...
\begin{tikzpicture}[scale=0.35, >=stealth]
  ...
  \draw[->, line width=2pt] (0, 5) -- (0, 6);
  \draw[->, line width=2pt] (0, 5) -- (1, 4);
\end{tikzpicture} 
\begin{tikzpicture}[scale=0.35, >=stealth]
  \foreach \i in {\xMin,...,\xMax} {
      \draw [very thin,gray] (\i,\yMin) -- (\i,\yMax);
  ...
  \draw[->, line width=2pt] (0, 5) -- (0, 6);
  \draw[->, line width=2pt] (0, 5) -- (1, 4);
  \draw[->, line width=2pt] (0, 6) -- (0, 7);
  \draw[->, line width=2pt] (0, 6) -- (1, 5);
  \draw[->, line width=2pt] (1, 4) -- (1, 5);
  \draw[->, line width=2pt] (1, 4) -- (2, 3);
\end{tikzpicture} 
\begin{tikzpicture}[scale=0.35, >=stealth]
  \foreach \i in {\xMin,...,\xMax} {
      \draw [very thin,gray] (\i,\yMin) -- (\i,\yMax);
  ...
  \draw[->, line width=2pt] (1, 4) -- (1, 5);
  \draw[->, line width=2pt] (1, 4) -- (2, 3);
  \draw[->, line width=2pt] (0, 7) -- (0, 8);
  \draw[->, line width=2pt] (0, 7) -- (1, 6);
  \draw[->, line width=2pt] (1, 5) -- (1, 6);
  \draw[->, line width=2pt] (1, 5) -- (2, 4);
  \draw[->, line width=2pt] (2, 3) -- (2, 4);
  \draw[->, line width=2pt] (2, 3) -- (3, 2);
\end{tikzpicture}
