...
\begin{figure}[t]
  ...
  \begin{minipage}{0.5\linewidth}
    ...
    \end{tikzpicture}
    \caption{Robot's reachable positions.}
...
This example demonstrates that we can prove the robot never falls in
...
\begin{figure}[t]
  ...
  \end{tikzpicture}
  \caption{Unreachable positions from \cref{fig:robot-inductive-invariant}.}
