...
{morekeywords={mutable, immutable, constant, relation, function, 
               ...
               sort, forall, axiom, theorem, zerostate, onestate, twostate},
sensitive=false,
morecomment=[l]{\#},
...
\usepackage[mincrossrefs=99, maxbibnames=99, style=numeric-comp, natbib=true]{biblatex}
...
\dedication{\begin{center}\emph{To Barkley}\end{center}}
